...
class CustomStylesSelector:
    ...
    def INPUT_TYPES(cls):
        ...
        # FIX: Keep ALL styles in input registration so backend validation passes
...
NODE_CLASS_MAPPINGS = {"CustomStylesSelectorv2": CustomStylesSelector}
NODE_DISPLAY_NAME_MAPPINGS = {"CustomStylesSelectorv2": "Easy Styles Selector v2"}