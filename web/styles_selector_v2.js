...
app.registerExtension({
    name: "agi.CustomStylesSelectorv2.Extension",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "CustomStylesSelectorv2") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                function syncStylesData() {
                    ...
                    const filterStylesByCategory = () => {
                        ...
                        styleWidget.options.values = filtered.length > 0 ? filtered.map(item => item.name) : ["None"];
                ...
                // FIX: Hook into onConfigure to enforce category filtering when loading workflows
            ...
            nodeType.prototype.onMouseDown = function (e, local_pos) {
                if (local_pos[1] >= 285 && local_pos[1] <= 345 && local_pos[0] >= 210) {
            ...
            nodeType.prototype.computeSize = function() { return [350, 370]; };
